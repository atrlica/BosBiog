...
street.res <- fread("processed/results/street/streettrees.TOTAL.npp.simulator.v7.results.random.csv")
...
andy.res <- fread("processed/results/andy.TOTALnpp.results.V7.csv")
...
writeRaster(rr, filename="processed/results/hybrid.V8.TOTAL.npp.median.tif", format="GTiff", overwrite=T)
